...
code digest is `ac4ead0c7421fbda5512716f7a3412e8206167bba7c6b8638378102245095a8c`); the committed hero stays
...
| Project gates | `VERIFIED` | Locked sync, formatting, Ruff, mypy, 325 local tests, sdist, and wheel pass. |

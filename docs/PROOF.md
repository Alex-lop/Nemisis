...
code digest is `564cb3f5f46e0f7773ed3e0b861842d62fd2bfd91b2ba32266748d03872338b6`); when they do,
...
| Project gates | `VERIFIED` | Locked sync, formatting, Ruff, mypy, 377 local tests, sdist, and wheel pass. |

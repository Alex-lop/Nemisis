...
code digest is `0bdc49a902ebf43d8af292c3ce204df735e8c1505a92c8bbd883ce16db27a76d`); the committed hero stays
...
| Project gates | `VERIFIED` | Locked sync, formatting, Ruff, mypy, 312 local tests, sdist, and wheel pass. |

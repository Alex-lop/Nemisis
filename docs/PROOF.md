...
code digest is `287fdf46da3717cd82200e8149aa8c7077c961a695347f99c90f6b7f66da279b`); when they do,
...
| Project gates | `VERIFIED` | Locked sync, formatting, Ruff, mypy, 353 local tests, sdist, and wheel pass. |

...
from nemisis.scenarios import sqlite_credit_v1, sqlite_inventory_v1, sqlite_webhook_idempotency_v1
...
SCENARIOS: Mapping[str, Scenario] = {
    ...
    sqlite_webhook_idempotency_v1.SCENARIO.scenario_id: sqlite_webhook_idempotency_v1.SCENARIO,
}

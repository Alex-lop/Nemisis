...
| 12 | The nightly is green at the final engine | – | PASS | `gh workflow run nightly.yml --ref main` at `cc8d189`, then [run 34869026489](https://github.com/Alex-lop/Nemisis/actions/runs/34869026489) → success, both scenarios, 300 handlers each, 0 disagreements, 0 unknown; the engine digest is `1afdb6ee…`, unchanged by the wrapper merges |
